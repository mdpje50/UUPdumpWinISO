@echo off
:: Generated on 2026-07-30 08:54:07 GMT
...
:START_PROCESS
title 26200.8973_amd64_zh-cn_multi_b407eb4e download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b407eb4e-c0c2-47e8-a60c-ae837d058d1e&pack=zh-cn&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
